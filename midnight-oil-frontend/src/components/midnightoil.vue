  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <strong>Step 2: </strong>Book a session. Avoid booking multiple sessions if you cannot go to all of them. You can sort the table by the number of existing requests.<br>
     ...
     <table class="table" id="rememberedSessions">
      <thead>
        <tr>
          ...
          <th class="no-sort" scope="col">Session Time</th>
